<div class="page-head">
  ...
  <div style="display:flex;gap:10px">
    <a class="btn btn-ghost" href="<?= url('billing') ?>">← Back to billing</a>
...
<div class="card inline-panel" id="entity-panel">
  <form method="post" action="<?= url('billing/entities') ?>" id="entity-form">
      ...
      <?php foreach ($entities as $e): ?>
        <tr>
          ...
          <td style="text-align:right;white-space:nowrap">
            ...
            <?php if ($e['is_active']): ?>
              <form method="post" action="<?= url('billing/entities') ?>" style="display:inline" onsubmit="return confirm('Deactivate this entity? Past invoices stay exactly as they are.')">
                <?= csrf_field() ?>

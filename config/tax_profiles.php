 ...
 *
 * One entry per "how is this invoice taxed" scenario. billing.php uses
 * the entity's country + the client's country/state to SUGGEST a
 * default profile, but the person issuing the invoice can always
 * override it from the dropdown — cross-border place-of-supply rules
 * (especially intra-GCC reverse charge) have enough edge cases that a
 * human in the loop is safer than a fully automatic decision.
 *
